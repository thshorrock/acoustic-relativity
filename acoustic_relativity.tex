...
gauge quantities that are independent of the observer's motion.
...
%
%and secondly because the \aether\ is assumed not to alter the length of a {\em rigid} measuring device (physical idendity of the the units of measure - a consiquence of Einstein's relativity postulatethe relativity postulate).
The observer can therefore consider themselves to be stationary and not consider the \aether\ at all.
...
\Poincare\ assumes  that there is no absolute reference from  which to measure the speed of the \aether.
However, in its refusal of an absolute frame of reference, \Poincare's relativity postulate does
enable a complete theory of special relativity to be derived.
From it \Poincare\ determines the temporal Lorentz transformation from the spatial transformation.
...
The contraction is real in the sense that it  will be reproducibly measured.
